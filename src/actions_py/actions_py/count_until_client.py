...
class CountUntilClientNode(Node):
    ...
    def send_goal(self, target_number, period):
        ...
        # Send goal (and set feedback callback)
        ...
        # Send a cancek request 2 sec later
    ...
    def goal_response_callback(self, future):
        # Confirm whether goal is accepted or not
    ...
    def goal_result_callback(self, future):
        # Receive result and the final status (success/abort/cancel)
