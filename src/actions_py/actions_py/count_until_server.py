...
class CountUntilServerNode(Node):
    ...
    def goal_callback(self, goal_request: CountUntil.Goal):
        ...
        # with self.goal_lock_: #make sure the self.goal_handle is from the same thread
        #     if self.goal_handle_ is not None and self.goal_handle_.is_active:  # once execute done, goal handle changes to false 
    ...
    def handle_accepted_callback(self, goal_handle: ServerGoalHandle):
        with self.goal_lock_:
                if self.goal_handle_ is not None:
                    ...
                    goal_handle.execute()  # Let the first goal pass
    ...
    def execute_callback(self, goal_handle: ServerGoalHandle):
        ...
        # Once mission is done, set goal status to succeed (or aborted)
        goal_handle.succeed()
